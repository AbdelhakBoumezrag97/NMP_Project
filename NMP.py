...
def check_version(connection):
	...
	output_version = connection.send_command('show version') #hada star kan ta7t l for
...
def main():
    ...
    conf_menu = TerminalMenu(conf_menu_items, conf_menu_title)
    ...
    ver_menu_back = False
    ver_menu = TerminalMenu(ver_menu_items, ver_menu_title)
    ...
    com_menu_back = False
    com_menu = TerminalMenu(com_menu_items, com_menu_title)
    ...
    ch_menu_back = False
    ch_menu = TerminalMenu(ch_menu_items, ch_menu_title)
...
if __name__ == "__main__":
	...
	while True:
		...
		if username.lower() == 'admin'and password.lower() =='2020':
			break
		else: 
